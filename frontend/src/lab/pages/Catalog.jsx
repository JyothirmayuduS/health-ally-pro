      ...
      <SectionLabel
        action={
          <div className="text-xs font-mono uppercase tracking-wider text-stone-500">
            {filtered.length} of {catalog.length} tests
          </div>
        }
      >
        Test catalog
      ...
      <div className="bg-white rounded-xl border border-stone-200 p-4 flex flex-wrap gap-3 items-center">
        <div className="relative flex-1 min-w-[260px]">
          ...
          <Input
            ...
            placeholder="Search by name or code (CBC, LIPID…)"
        ...
        {filtered.map((t) => (
          <div key={t.code} className="bg-white rounded-xl border border-stone-200 p-5" data-testid={`catalog-${t.code}`}>
            <div className="flex items-start justify-between mb-3">
              ...
              <div className="flex items-center gap-1 text-sm font-mono text-[var(--sage-700)]">
