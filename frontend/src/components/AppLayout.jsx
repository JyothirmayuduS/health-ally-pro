    ...
    <div className="flex min-h-screen bg-paper text-ink-900">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        <header
          ...
          className="print-hide sticky top-0 z-20 bg-paper/90 backdrop-blur-sm border-b border-ink-200"
        >
          <div className="flex items-center gap-3 sm:gap-5 px-4 sm:px-6 lg:px-8 py-3 sm:py-4">
            <MobileSidebarTrigger />
            <div className="min-w-0 flex-shrink-0">
              <div className="text-[10.5px] uppercase tracking-[0.14em] text-ink-400 font-mono font-medium">
                {eyebrow}
              </div>
              <h1 className="text-[18px] sm:text-[22px] font-heading font-semibold text-ink-900 leading-tight mt-0.5 truncate">
                {title}
              </h1>
            </div>
            ...
            <div className="flex-1 max-w-md hidden md:block">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-9 pl-9 pr-3 text-[13px] bg-white border border-ink-200 rounded-md focus:outline-none focus:border-sage focus:ring-1 focus:ring-sage placeholder:text-ink-400"
                />
              </div>
            </div>

            <div className="ml-auto flex items-center gap-3 sm:gap-5 text-[12px]">
              <div className="hidden md:flex items-center gap-2 text-ink-600">
        ...
        <div className="flex-1 px-4 sm:px-6 lg:px-8 py-5 sm:py-6 animate-fade-in print-area">
          <Outlet />
        </div>
      </main>
