  ...
  return (
    <div data-testid="landing-page" className="min-h-screen flex items-center justify-center p-8 bg-background">
      <div className="max-w-md w-full text-center">
        ...
        <p className="mt-3 text-muted-foreground text-[14px]">Pharmacy desk — sign in to enter the demo.</p>
        <div className="mt-8 grid grid-cols-1 gap-3">
          <Link to="/login" data-testid="cta-login"
            ...
            <div className="flex-1">
              ...
              <div className="text-[12px] text-muted-foreground">Use the seeded pharmacy demo account.</div>
            </div>
            <ArrowRight className="h-4 w-4 text-muted-foreground" />
          </Link>
          <div className="pharm-card p-4 text-left">
            <div className="text-[11px] uppercase tracking-wider text-muted-foreground mb-2">Demo account</div>
