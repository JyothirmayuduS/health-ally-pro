  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-[11.5px] text-gray-400 font-mono mt-0.5 truncate">
          {id} · {phone}
        </div>
      </div>
...
function DoctorOption({
  ...
  return (
    ...
    >
      ...
      {fee > 0 && (
        <div
          className="shrink-0 flex items-center gap-0.5 font-bold font-mono text-[13px]"
          style={{ color: "#1a7a1a" }}
        >
        ...
        <div className="flex-1 overflow-y-auto" style={{ background: "#F8F9FA" }}>
          ...
          {step === 1 && (
            <div className="p-5 space-y-4">
              {/* Pill tab switcher */}
              <div className="flex p-1 rounded-2xl" style={{ background: "#EBEBEA" }}>
          ...
          {step === 3 && (
            <div className="p-5 space-y-4">
              <p className="text-[12.5px] text-gray-500">
                Review the appointment before confirming.
              </p>
              <div
              ...
              >
                {selectedPat && (
                  <DetailRow
                    icon={
                      <div
                        className="h-5 w-5 rounded-lg flex items-center justify-center text-[10px] font-bold"
                        style={{ background: "#2C7A5B", color: "#fff" }}
                      >
                        {getInitials(selectedPat.name)}
                      </div>
        ...
        >
          ...
          {step === 3 && (
            <button
              ...
              style={{
                background: "linear-gradient(135deg, #1A5C3A, #226B44)",
                boxShadow: "0 4px 16px rgba(26,92,58,0.35)",
              }}
            >
