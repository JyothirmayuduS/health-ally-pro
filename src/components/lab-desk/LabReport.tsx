        ...
        <div className="print-area px-10 py-10 text-ink-900">
          <div className="flex items-start justify-between pb-6 border-b-2 border-[var(--sage-700)]">
            <div>
              ...
              <div className="text-xs text-ink-400 mt-2 leading-relaxed">
                {hospital.address}
                <br />
          ...
          <div className="grid grid-cols-2 gap-6 mt-6 text-sm">
            ...
            <div>
              ...
              <div className="text-stone-700">
                Ordered by: <b>{order.doctor_name}</b>
              </div>
          ...
          <div className="mt-8 mb-2">
            <div className="font-display text-lg font-semibold border-b border-stone-300 pb-2">
              {catalog?.name}{" "}
              <span className="font-mono text-sm text-ink-400">({catalog?.code})</span>
            </div>
          ...
          <table className="w-full text-sm mt-4 border-collapse">
            <thead>
              <tr className="border-b-2 border-stone-300 text-left">
                <th className="py-2 text-[11px] font-mono uppercase tracking-wider text-ink-400 font-medium">
                  Parameter
                </th>
                <th className="py-2 text-[11px] font-mono uppercase tracking-wider text-ink-400 font-medium">
                  Result
                ...
                return (
                  <tr key={p.key} className="border-b border-stone-100">
                    ...
                    <td className="py-2.5">
                      ...
                      {(f.level === "low" || f.level === "high") && (
                        <span className="font-mono font-semibold text-amber-700">{f.label}</span>
                      )}
          ...
          <div className="mt-12 pt-6 border-t border-stone-300 grid grid-cols-2 gap-6 text-xs">
            <div>
              <div className="text-ink-400 mb-8 font-mono uppercase tracking-wider">
                Validated by
              </div>
