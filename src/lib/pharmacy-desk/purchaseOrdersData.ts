...
export type POStatus = "draft" | "submitted" | "partially-received" | "received" | "cancelled";
...
export const SEED_PURCHASE_ORDERS: PurchaseOrder[] = [
  {
    ...
    items: [
      ...
      { drug_id: "drug-ato40", drug_name: "Atorvastatin 40 mg", qty_ordered: 1000, unit_cost: 0.3 },
    ],
  },
  {
    id: "po-2",
  ...
  },
  {
    ...
    items: [
      ...
      { drug_id: "drug-ome20", drug_name: "Omeprazole 20 mg", qty_ordered: 300, unit_cost: 0.4 },
    ],
  },
];
