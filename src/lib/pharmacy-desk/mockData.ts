    ...
    lines: [
      {
        id: "l4",
        drug_id: "drug-amx500",
        sig: "250 mg (½ tab) three times daily",
        qty_prescribed: 21,
        qty_dispensed: 0,
        days_supply: 7,
        refills_allowed: 0,
    ...
    lines: [
      {
        id: "l7",
        drug_id: "drug-par500",
        sig: "1 g every 6 hours PRN pain",
        qty_prescribed: 40,
        qty_dispensed: 40,
        days_supply: 10,
        refills_allowed: 0,
    ...
    lines: [
      {
        id: "l8",
        drug_id: "drug-oxy5",
        sig: "5 mg every 6 hours PRN severe pain",
        qty_prescribed: 12,
        qty_dispensed: 0,
        days_supply: 3,
        refills_allowed: 0,
...
export const SEED_ALERTS: PharmacyAlert[] = [
  {
    id: "al-1",
    level: "critical",
    title: "Fridge-2 temp excursion",
    body: "Recorded 9.2 °C for 12 min — verify insulin stock.",
    at: ago(20),
    action_label: "View cold chain",
    action_to: "/pharmacy/map",
  },
  {
    id: "al-2",
    level: "warning",
    title: "Omeprazole below reorder",
    body: "8 units on hand · reorder at 40 · A2-T09-S6",
    at: ago(90),
    action_label: "Receive stock",
    action_to: "/pharmacy/inventory",
  },
  {
    id: "al-3",
    level: "warning",
    title: "Rx SLA breach",
    body: "RX-2025-00421 waiting 12m in inbox — pediatric urgent.",
    at: ago(12),
    action_label: "Open inbox",
    action_to: "/pharmacy/prescriptions",
  },
  {
    id: "al-4",
    level: "info",
    title: "Flu vaccine batch expiring",
    body: "LOT-V88 expires in 28 days · FRIDGE-1-T02-S4",
    at: ago(200),
    action_label: "Expiry hub",
    action_to: "/pharmacy/operations",
  },
];
