...
export const DDI_RULES: DDIRule[] = [
  {
    ...
    recommendation:
      "Avoid concurrent use unless specifically directed. Monitor INR and signs of bleeding.",
  },
  {
    drugA: "Metformin",
    drugB: "Alcohol",
    severity: "moderate",
    effect:
      "Potentiates Metformin's effect on lactate metabolism, raising the risk of lactic acidosis.",
  ...
  },
  {
    ...
    severity: "moderate",
    effect:
      "Amlodipine increases systemic exposure of Simvastatin, raising myopathy/rhabdomyolysis risk.",
  ...
  },
  {
    ...
    recommendation:
      "Administer Ciprofloxacin at least 2 hours before or 6 hours after antacids/calcium.",
  },
  {
    drugA: "Fluoxetine",
    drugB: "Tramadol",
    severity: "major",
    effect:
      "Increased risk of serotonin syndrome and potential reduction of Tramadol's analgesic efficacy.",
    recommendation:
      "Monitor closely for serotonergic signs (tremor, hyperreflexia). Consider alternative analgesics.",
  },
  {
    drugA: "Sertraline",
    drugB: "Tramadol",
    ...
    recommendation:
      "Monitor for mental status changes and autonomic instability. Discontinue if serotonin syndrome suspected.",
  },
  {
    drugA: "Methotrexate",
    drugB: "Ibuprofen",
    severity: "major",
    effect:
      "NSAIDs reduce renal clearance of Methotrexate, leading to toxicity (bone marrow suppression).",
    recommendation:
      "Avoid concurrent use. Use alternative non-NSAID analgesics (e.g., Paracetamol).",
  },
  {
    drugA: "Digoxin",
    drugB: "Amiodarone",
    severity: "major",
    effect:
      "Amiodarone increases serum Digoxin concentrations by reducing renal/non-renal clearance.",
    recommendation:
      "Reduce Digoxin dose by 30% to 50% when initiating Amiodarone. Monitor serum Digoxin levels.",
  },
  {
    drugA: "Clopidogrel",
    drugB: "Omeprazole",
    ...
    recommendation:
      "Consider using Pantoprazole as an alternative PPI which has less CYP2C19 inhibition.",
  },
  {
    drugA: "Nitroglycerin",
    drugB: "Sildenafil",
    ...
    recommendation:
      "Strictly contraindicated. Sildenafil should not be used within 24 hours of Nitroglycerin.",
  },
  {
  ...
  },
  {
    ...
    severity: "major",
    effect:
      "Gemfibrozil inhibits statin glucuronidation, raising statin levels and risk of rhabdomyolysis.",
  ...
  },
  {
    ...
    severity: "major",
    effect:
      "Strong CYP3A4 inhibition by Clarithromycin significantly increases Simvastatin levels.",
    recommendation:
      "Hold Simvastatin therapy during course of Clarithromycin. Monitor for muscle pain.",
  },
  {
    drugA: "Levofloxacin",
    drugB: "Amiodarone",
    ...
    recommendation:
      "Avoid concurrent use. Use alternative non-fluoroquinolone antibiotic if possible.",
  },
  {
    drugA: "Gliclazide",
    drugB: "Ciprofloxacin",
    ...
    recommendation:
      "Monitor blood glucose levels frequently. Educate patient on signs of hypoglycemia.",
  },
  {
    drugA: "Levodopa",
  ...
  },
  {
    ...
    severity: "major",
    effect:
      "Ciprofloxacin inhibits theophylline clearance, increasing risk of seizures and arrhythmias.",
    recommendation:
      "Avoid concurrent use. If necessary, monitor theophylline levels closely and adjust dose.",
  },
];
