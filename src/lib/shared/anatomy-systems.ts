...
export const VIEW_PRESETS: { id: ViewPreset; label: string; visibility: SystemVisibility; xrayMuscles?: boolean }[] = [
  { id: "surface", label: "Body", visibility: { bone: true, muscle: true, nerve: false, vessel: false } },
  { id: "skeleton", label: "Skeleton", visibility: { bone: true, muscle: false, nerve: false, vessel: false } },
  { id: "vascular", label: "Blood flow", visibility: { bone: true, muscle: false, nerve: false, vessel: true } },
  { id: "nervous", label: "Nerves", visibility: { bone: true, muscle: false, nerve: true, vessel: false } },
  { id: "inside", label: "Inside", visibility: { bone: true, muscle: false, nerve: true, vessel: true }, xrayMuscles: true },
];
