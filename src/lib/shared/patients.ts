...
export const SHARED_PATIENTS: SharedPatient[] = [
  ...
  },
  {
    ...
    address: "402 Palm Springs, Juhu, Mumbai",
    emergency: { name: "Priya Mehta", phone: "+91 98765 11002", relation: "Mother" },
    bloodGroup: "B+",
    allergies: "—",
    insurance: { provider: "Star Health", policyId: "SH-PED-2201" },
    balance: 0,
