...
export const SEED_LEAVE_REQUESTS: StaffLeaveRequest[] = [
  ...
  },
  {
    ...
    toDate: dateStr(2),
    days: 2,
    reason: "Viral fever — certified unfit for duty",
    status: "approved",
    locumCoverName: "Dr. Aarav Mehta",
  ...
  },
  {
    ...
    status: "approved",
    decidedAt: new Date(Date.now() - 30 * 86400_000).toISOString(),
    decidedBy: "Admin User",
  },
  {
    id: "SLR-008",
  ...
  // Staff
  {
    ...
    status: "approved",
    decidedAt: new Date(Date.now() - 10 * 86400_000).toISOString(),
    decidedBy: "Admin User",
  },
  {
    id: "SLR-010",
    ...
    toDate: dateStr(2),
    days: 2,
    reason: "Medical emergency of a family member",
    status: "pending",
  },
  {
    id: "SLR-011",
...
export const PERFORMANCE_DATA: PerformanceRecord[] = [
  ...
  },
  {
    ...
    attendancePct: 88,
    reviewScore: 3.1,
    hikeRecommendation: "below-average",
  },
];
