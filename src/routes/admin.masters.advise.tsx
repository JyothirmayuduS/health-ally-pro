...
import { loadAdviseTemplates, saveAdviseTemplates, type AdviseTemplate } from "@/lib/hospital-masters";
...
function AdviseTemplatesPage() {
  ...
  return (
    <div className="space-y-4" data-testid="admin-advise-templates">
      <DeskPanel title="Advise templates" subtitle="Doctor → View Rx → Advise (multilingual snippets)">
          ...
          {rows.map((r) => (
            <li key={r.id} className="p-4">
              <div className="flex items-center gap-2">
                ...
                <span className="rounded bg-ink-100 px-2 py-0.5 font-mono text-[10px] uppercase">{r.locale}</span>
              </div>
