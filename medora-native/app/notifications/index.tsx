      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInDown.delay(200).duration(600)} style={styles.textWrap}>
          ...
          <Text style={[styles.subtitle, { color: colors.inkMuted }]}>
            Enable live updates to track your position in the clinic queue and receive precision
        ...
        <View style={styles.propGrid}>
          {[
            {
              title: "Live Queue",
              desc: "Know exactly when it's your turn.",
              icon: Clock4,
              color: "#4CAF7D",
            },
            {
              title: "Care Team",
              desc: "Instant messages from your doctors.",
              icon: Stethoscope,
              color: colors.clay,
            },
            {
              title: "Precision",
              desc: "Never miss a critical medication dose.",
              icon: Zap,
              color: colors.ink,
            },
          ].map((prop, i) => (
        ...
        <Animated.View entering={FadeInUp.delay(800).duration(600)} style={styles.footer}>
          {!isFinishing ? (
            ...
            <Animated.View entering={ZoomIn} style={styles.successWrap}>
              ...
              <Text style={[styles.successSub, { color: colors.inkMuted }]}>
                Sending a test notification now...
              </Text>
            </Animated.View>
          )}
        </Animated.View>
