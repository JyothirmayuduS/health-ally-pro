...
function PulseRing({ colors }: { colors: ThemeColors }) {
  ...
  return (
    <Animated.View
      style={[pr.ring, ringStyle, { backgroundColor: "#4CAF7D20", borderColor: "#4CAF7D40" }]}
    />
  );
}
  ...
  return (
    ...
    >
      ...
      <View style={s.hero}>
        {phase === "loading" ? (
          <View
            style={[s.outerCircle, { backgroundColor: colors.surface, borderColor: colors.border }]}
          >
          ...
          <>
            ...
            <Animated.View
              style={[
                s.outerCircle,
                outerStyle,
                { backgroundColor: "#4CAF7D18", borderColor: "#4CAF7D40" },
              ]}
            >
      ...
      {phase === "loading" ? (
        <Animated.View entering={FadeInDown.duration(400)} style={s.textBlock}>
          <Text style={[s.heading, { color: colors.foreground, fontSize: 32 }]}>Confirming...</Text>
              ...
              {doctor && (
                <View style={[s.doctorRow, { borderBottomColor: colors.border }]}>
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={[s.doctorSpec, { color: colors.inkMuted }]}>
                      {doctor.specialty}
                    </Text>
                  </View>
                  <View
