  ...
  const filteredMeals = useMemo(() => {
    return dietMeals.filter((m) => {
      ...
      const typeMatch =
        dietType === "all" ||
        m.type === dietType ||
        (dietType === "indian" && m.id.startsWith("in"));
        ...
        <Animated.View entering={FadeInDown.duration(400)}>
          <View style={s.header}>
            ...
            <Text style={[s.subtitle, { color: colors.inkMuted }]}>
              Nutritionally optimized for{" "}
              {takesThyroidMeds ? "Thyroid Support" : "Metabolic Health"}
            </Text>
          </View>
        </Animated.View>
          ...
          <View style={[s.budgetBar, { backgroundColor: colors.surface }]}>
            {(["essential", "balanced", "elite"] as const).map((b) => (
              <Pressable
                key={b}
                onPress={() => setBudget(b)}
                style={[s.budgetBtn, budget === b && { backgroundColor: colors.ink }]}
              >
                <Text
                  style={[
                    s.budgetTxt,
          ...
          >
            {[
              ...
              <Pressable
                ...
                style={[
                  s.filterChip,
                  {
                    ...
                    borderColor: dietType === f.id ? colors.clay : colors.border,
                  },
              ...
              >
                ...
                <Text
                  style={[
                    s.filterTxt,
                    { color: dietType === f.id ? colors.foreground : colors.inkMuted },
                  ]}
                >
                  {f.label}
                </Text>
            ...
            <Pressable
              ...
              style={[
                ...
                {
                  backgroundColor: colors.surface,
                  borderColor: lactoseFree ? "#4CAF7D" : colors.border,
                },
            ...
            >
              ...
              <Text
                style={[s.filterTxt, { color: lactoseFree ? colors.foreground : colors.inkMuted }]}
              >
                Lactose-Free
              </Text>
            </Pressable>
        ...
        {takesThyroidMeds && (
          <Animated.View entering={FadeIn.duration(600).delay(300)}>
            <View
              style={[
                s.warningCard,
                { backgroundColor: colors.surface, borderColor: colors.clay + "30" },
              ]}
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  ...
                  <View style={[s.activeBadge, { backgroundColor: "#4CAF7D15" }]}>
                    <Text style={{ fontSize: 9, color: "#4CAF7D", fontFamily: "DMSans_700Bold" }}>
                      ACTIVE
                    </Text>
                  </View>
                </View>
                <Text style={[s.warningBody, { color: colors.inkMuted }]}>
                  Your plan is currently avoiding competitive nutrients (Iron, Calcium, Soy) to
                  maximize medication bioavailability.
                </Text>
                <Pressable
                  onPress={() => {
