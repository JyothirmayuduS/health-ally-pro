    ...
    return (
      <View style={[s.successWrap, { backgroundColor: colors.background, paddingTop: insets.top }]}>
        ...
        <Animated.View
          ...
          style={{ marginTop: 28, width: "100%", paddingHorizontal: 32 }}
        >
          <Pressable
            onPress={() => router.replace("/medications/refill-history")}
            style={[s.historyBtn, { borderColor: colors.border }]}
          >
            <Text style={[s.historyBtnText, { color: colors.foreground }]}>
              View refill history
            </Text>
          </Pressable>
          <Pressable onPress={() => router.back()} style={{ marginTop: 16, alignItems: "center" }}>
            <Text style={{ fontSize: 15, fontFamily: "DMSans_500Medium", color: colors.inkMuted }}>
              Done
            </Text>
          </Pressable>
        </Animated.View>
    ...
    <View style={[s.container, { backgroundColor: colors.background }]}>
      ...
      >
        <Animated.View entering={FadeInDown.duration(400)} style={s.contentPad}>
          ...
          <Text style={[s.medContext, { color: colors.inkMuted }]}>
            {med.dosage} • {med.frequency}
          </Text>

          {/* Trust Anchor */}
          <View
            style={[s.trustCard, { backgroundColor: colors.surface, borderColor: colors.border }]}
          >
            <ShieldCheck size={20} color={colors.clay} />
            <View style={{ flex: 1 }}>
              <Text style={[s.trustTitle, { color: colors.foreground }]}>Direct Authorization</Text>
              <Text style={[s.trustSub, { color: colors.inkMuted }]}>
          ...
          <Pressable
            style={[
              s.methodCard,
              {
                ...
                borderColor: deliveryMethod === "delivery" ? colors.clay : colors.border,
              },
          ...
          >
            <View
              style={[
                s.methodIcon,
                { backgroundColor: deliveryMethod === "delivery" ? colors.clay : colors.border },
              ]}
            >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={[s.methodSub, { color: colors.inkMuted }]}>
                Usually ships in 1-2 business days to your flat.
              </Text>
            </View>
            <View
              style={[
            ...
            >
              {deliveryMethod === "delivery" && (
                <View style={[s.radioInner, { backgroundColor: colors.clay }]} />
              )}
            </View>
          </Pressable>
          ...
          <Pressable
            style={[
              ...
              {
                backgroundColor: colors.surface,
                borderColor: deliveryMethod === "pickup" ? colors.clay : colors.border,
              },
          ...
          >
            <View
              style={[
                s.methodIcon,
                { backgroundColor: deliveryMethod === "pickup" ? colors.clay : colors.border },
              ]}
            >
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={[s.methodSub, { color: colors.inkMuted }]}>
                Oakhaven Medical Center Pharmacy. Same day.
              </Text>
            </View>
            <View
              style={[
      ...
      >
        <Pressable
          style={[
            s.actionBtn,
            { backgroundColor: status === "submitting" ? colors.inkMuted : colors.ink },
          ]}
