...
export default function DoctorProfileScreen() {
  ...
  const stickyHeaderStyle = useAnimatedStyle(() => {
    ...
    return {
      opacity,
      transform: [
        { translateY: interpolate(scrollY.value, [80, 120], [20, 0], Extrapolate.CLAMP) },
      ],
  ...
  const cardNameStyle = useAnimatedStyle(() => {
    const opacity = interpolate(scrollY.value, [60, 100], [1, 0], Extrapolate.CLAMP);
    return { opacity };
  });
        ...
        <Animated.View style={[styles.headerContainer, parallaxStyle]}>
          ...
          <View style={StyleSheet.absoluteFill}>
            ...
            <View
              style={[
                styles.shape,
                { top: -20, right: -30, backgroundColor: "rgba(255,255,255,0.1)" },
              ]}
            />
            <View
              style={[
                styles.shape,
                { bottom: -40, left: -20, backgroundColor: "rgba(0,0,0,0.05)" },
              ]}
            />
          </View>
        ...
        <Animated.View entering={FadeInDown.duration(600)} style={styles.mainCard}>
          ...
          >
            <View style={styles.avatarRow}>
              ...
              <View style={styles.identityText}>
                ...
                <View style={styles.ratingRow}>
                  ...
                  <Text style={[styles.reviewCount, { color: colors.inkMuted }]}>
                    · 120 reviews
                  </Text>
                </View>
              </View>
            ...
            <View style={styles.clinicInfo}>
              ...
              <View style={styles.clinicDetails}>
                <Text style={[styles.clinicName, { color: colors.foreground }]}>
                  {doc.location || doc.hospital}
                </Text>
                <Text style={[styles.clinicAddr, { color: colors.inkMuted }]}>
                  Consultation Room 4 · Floor 2
                </Text>
              </View>
            </View>
          </View>
          ...
          <View style={styles.section}>
            ...
            >
              <View style={styles.infoRow}>
                ...
                <Text style={[styles.infoText, { color: colors.inkMuted }]}>
                  {doc.education || "Board certified specialist."}
                </Text>
              </View>
                  ...
                  <View key={med.id}>
                    <View style={styles.medRow}>
                      ...
                      <View style={{ flex: 1 }}>
                        ...
                        <Text style={[styles.medSub, { color: colors.inkMuted }]}>
                          {med.dosage} · {med.frequency}
                        </Text>
                      </View>
                    </View>
                    {idx < docMeds.length - 1 && (
                      <View
                        style={[
                          styles.miniDivider,
          ...
          <View style={styles.section}>
            ...
            <Pressable
              ...
              onPress={() => router.push(`/doctor/schedule/${doc.id}`)}
            >
              <View>
                <Text style={[styles.nextAvail, { color: colors.inkMuted }]}>
                  Next available slot
                </Text>
          ...
          <View style={styles.section}>
            ...
            >
              {[
                {
                  text: "Dr. Thorne completely changed my approach to heart health. The metabolic focus was exactly what I needed.",
                  patient: "Sarah M.",
                  tag: "Hypertension",
                },
                {
                  text: "Incredibly thorough and empathetic. The telehealth interface makes follow-ups so easy.",
                  patient: "James L.",
                  tag: "Wellness",
                },
                {
                  text: "Finally found a doctor who looks at the root cause rather than just treating symptoms.",
                  patient: "Elena R.",
                  tag: "Recovery",
                },
              ].map((t, idx) => (
                ...
                >
                  ...
                  <Text style={[styles.patientName, { color: colors.inkMuted }]}>
                    — {t.patient}
                  </Text>
                </View>
              ))}
