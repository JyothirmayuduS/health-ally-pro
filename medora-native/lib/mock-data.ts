...
export const medications: Medication[] = [
  ...
  },
  {
    ...
    sideEffects: [
      "Hypercalcemia (too much calcium in blood at excessive doses)",
      "Nausea or mild vomiting",
      "Confusion or rhythm issues (rare)",
    ],
    interactions: [
    ...
    bestWayToTake:
      "Vitamin D is fat-soluble. To maximize absorption, take it alongside a heavy meal containing healthy fats (like olive oil, avocado, or nuts).",
  ...
  },
  {
    ...
    sideEffects: [
      "Mild gastrointestinal upset (much rarer than Citrate)",
      "Lethargy if taken with heavy sedatives",
      "Magnesium toxicity in patients with Kidney Disease",
    ],
    interactions: [
    ...
    bestWayToTake:
      "Take 1 to 2 hours before bedtime. This specific amino-acid chelated form is highly absorbable and gentle on the stomach, so it can be taken with or without food. Separate from antibiotics by 2-4 hours.",
    alternatives: [
      "Magnesium Citrate (Laxative effect)",
      "Magnesium L-Threonate (Cognitive focus)",
    ],
    pillsRemaining: 18,
    totalPills: 30,
...
export const dietMeals: DietMeal[] = [
  // --- ESSENTIAL (BUDGET) ---
  {
    ...
    calories: 320,
    clinicalRationale:
      "A baseline metabolic starter. Iodized salt provides the primary substrate for thyroxine synthesis, while soluble fiber ensures a stable insulin response.",
    instructions: [
    ...
    metabolicImpact: [
      {
        time: "30m",
        effect: "Iodine Loading",
        description: "Substrate availability increases for thyroid follicular cells.",
      },
      {
        time: "2h",
        effect: "Satiety Peak",
        description: "Beta-glucans from oats stabilize glucose and sustain energy levels.",
      },
    ],
    clinicalBenefits: [
      {
        title: "Hormone Base",
        description: "Provides essential iodine for T4 production.",
        icon: "Activity",
      },
      {
        title: "Metabolic Steady",
        description: "Slow-release carbs for thyroid stability.",
        icon: "Flame",
      },
    ],
  ...
  },
  {
    ...
    calories: 450,
    clinicalRationale:
      "Sardines are a nutrient powerhouse. High levels of Omega-3 reduce thyroidal inflammation, while Vitamin D supports immune modulation.",
    instructions: [
    ...
    metabolicImpact: [
      {
        time: "1h",
        effect: "Inflammation Drop",
        description: "EPA/DHA starts modulating systemic inflammatory markers.",
      },
      {
        time: "3h",
        effect: "Cellular Recovery",
        description: "Vitamin D3 begins genomic signaling for immune health.",
      },
    ],
    clinicalBenefits: [
      {
        title: "Anti-Inflammatory",
        description: "Omega-3 reduces systemic stress.",
        icon: "Shield",
      },
  ...
  },
  {
    ...
    calories: 380,
    clinicalRationale:
      "Zinc-dense lentils support the conversion of T4 to the active T3 hormone. Turmeric provides potent antioxidant protection for thyroid tissue.",
    instructions: [
    ...
    metabolicImpact: [
      {
        time: "1.5h",
        effect: "Enzyme Trigger",
        description: "Zinc availability activates peripheral deiodinase enzymes.",
      },
      {
        time: "4h",
        effect: "Antioxidant Flush",
        description: "Curcuminoids reach peak serum concentration for tissue protection.",
      },
    ],
    clinicalBenefits: [
      {
        title: "Active T3 Boost",
        description: "Zinc-driven hormone conversion.",
        icon: "Sparkles",
      },
      {
        title: "Tissue Protection",
        description: "Turmeric-mediated antioxidant defense.",
        icon: "Shield",
      },
    ],
  ...
  // --- BALANCED (OPTIMAL) ---
  {
    ...
    calories: 410,
    clinicalRationale:
      "Monounsaturated fats from avocado are essential for steroid hormone transport. Eggs provide choline for cognitive health, often impaired in thyroid conditions.",
    instructions: [
    ...
    metabolicImpact: [
      {
        time: "30m",
        effect: "Lipid Priming",
        description: "Healthy fats initiate bile release, optimizing fat-soluble vitamin uptake.",
      },
      {
        time: "2h",
        effect: "Cognitive Load",
        description: "Choline crosses the blood-brain barrier for neurotransmitter support.",
      },
    ],
    clinicalBenefits: [
      {
        title: "Hormone Transport",
        description: "Lipids for efficient hormone delivery.",
        icon: "Activity",
      },
      {
        title: "Neural Support",
        description: "Choline-mediated brain health optimization.",
        icon: "Cpu",
      },
    ],
  ...
  },
  {
    ...
    calories: 520,
    clinicalRationale:
      "A complete amino acid profile from chicken supports tissue repair. Magnesium from spinach and quinoa aids muscle relaxation and stress management.",
    instructions: [
    ...
    metabolicImpact: [
      {
        time: "1h",
        effect: "Amino Surge",
        description: "Essential amino acids reach serum peak for protein synthesis.",
      },
      {
        time: "4h",
        effect: "Muscular Ease",
        description: "Magnesium levels stabilize for optimized neuromuscular signaling.",
      },
    ],
    clinicalBenefits: [
      {
        title: "Muscle Synthesis",
        description: "Complete protein for metabolic tissue.",
        icon: "Activity",
      },
      {
        title: "Stress Recovery",
        description: "Magnesium-mediated cortisol balance.",
        icon: "Heart",
      },
    ],
  ...
  },
  {
    ...
    calories: 280,
    clinicalRationale:
      "Kelp is nature's richest source of iodine. Miso fermentation provides live probiotics to rebuild the gut lining, essential for autoimmune management.",
    instructions: [
    ...
    metabolicImpact: [
      {
        time: "30m",
        effect: "Probiotic Flush",
        description: "Live enzymes begin gut microbiome interaction.",
      },
      {
        time: "3h",
        effect: "Iodine Saturation",
        description: "Bioavailable iodine enters the thyroglobulin synthesis pathway.",
      },
    ],
    clinicalBenefits: [
      {
        title: "Microbiome Reset",
        description: "Fermented probiotics for gut health.",
        icon: "Shield",
      },
      {
        title: "Thyroid Substrate",
        description: "Marine-derived iodine for hormone synthesis.",
        icon: "Lightbulb",
      },
    ],
    aiIntelligence: {
      ...
      dataset: "Global Fermentation Data",
    },
  },
  ...
  // --- ELITE (PREMIUM) ---
  {
    ...
    calories: 580,
    clinicalRationale:
      "A micronutrient powerhouse. High Selenium content is clinical-grade for TPO antibody reduction, while Zinc and D3 synchronize for peak immune modulation.",
    instructions: [
    ...
    metabolicImpact: [
      {
        time: "1h",
        effect: "Selenium Saturation",
        description: "Selenium-dependent enzyme GPx activates, reducing thyroid oxidative stress.",
      },
      {
        time: "4h",
        effect: "Vascular Optimization",
        description: "High-dose Omega-3 modulates blood rheology and systemic inflammation.",
      },
    ],
    clinicalBenefits: [
      {
        title: "Antibody Reduction",
        description: "Selenium-mediated TPO support.",
        icon: "Sparkles",
      },
    ...
    aiIntelligence: {
      confidence: 0.99,
      model: "MedOra-DL-Core",
      dataset: "Precision Bio-Mining v4",
    },
  },
  {
    id: "el2",
    ...
    calories: 350,
    clinicalRationale:
      "Specifically designed for Selenium loading. Two Brazil nuts provide the exact clinical dosage required for Selenium-dependent deiodinases.",
    instructions: [
    ...
    metabolicImpact: [
      {
        time: "30m",
        effect: "Antioxidant Surge",
        description: "Anthocyanins from berries enter the cardiovascular system.",
      },
      {
        time: "3h",
        effect: "Enzyme Priming",
        description: "Selenium levels peak, activating deiodinase for T4 -> T3 conversion.",
      },
    ],
    clinicalBenefits: [
      {
        title: "Hormone Conversion",
        description: "Selenium for active T3 synthesis.",
        icon: "Flame",
      },
      {
        title: "Brain Health",
        description: "Wild berry polyphenols for cognitive fire.",
        icon: "Cpu",
      },
    ],
  ...
  },
  {
    ...
    calories: 420,
    clinicalRationale:
      "Scallops are high in Vitamin B12 and Zinc, which are essential for managing autoimmune thyroid symptoms and nerve health.",
    instructions: [
    ...
    metabolicImpact: [
      {
        time: "1h",
        effect: "Neural Activation",
        description: "B12 absorption supports myelin sheath integrity and energy.",
      },
      {
        time: "4h",
        effect: "Immune Response",
        description: "Zinc availability optimizes T-lymphocyte function.",
      },
    ],
    clinicalBenefits: [
      {
        title: "Energy Synthesis",
        description: "B12-mediated mitochondrial support.",
        icon: "Zap",
      },
      {
        title: "Immune Balance",
        description: "Zinc for autoimmune clinical stability.",
        icon: "Shield",
      },
    ],
    aiIntelligence: {
      confidence: 0.97,
      model: "MedOra-DL-Core",
      dataset: "Elite Clinical Marine Hub",
    },
  },
  // --- INDIAN WHOLE MEALS ---
  {
    ...
    calories: 380,
    clinicalRationale:
      "Pearl millet (Bajra) is a magnesium-rich grain that supports metabolic function. Paired with Moong Dal, it provides a complete amino acid profile for hormone synthesis.",
    instructions: [
    ...
    clinicalTips: [
      "Never eat raw pearl millet; thorough cooking neutralizes goitrogenic concerns.",
      "The 4-Hour Rule: Consume this high-fiber meal 4 hours away from Levothyroxine.",
    ],
    imageUrl: "bajra_khichdi_clinical_1776603015994.png",
    metabolicImpact: [
      {
        time: "45m",
        effect: "Serotonin Prime",
        description:
          "Complex carbohydrates trigger natural serotonin synthesis, improving morning mood and cortisol balance.",
      },
      {
        time: "3h",
        effect: "Metabolic Synthesis",
        description: "Selenium from Bajra activates the deiodinase enzyme, aiding T4 conversion.",
      },
    ],
    clinicalBenefits: [
      {
        title: "Metabolic Rate",
        description: "Supports resting energy expenditure.",
        icon: "Flame",
      },
      {
        title: "Thyroid Support",
        description: "Direct Selenium loading for thyroid tissue.",
        icon: "Sparkles",
      },
    ],
    aiIntelligence: {
  ...
  },
  {
    ...
    calories: 310,
    clinicalRationale:
      "Ragi is exceptionally high in calcium and iron. Fermentation improves gut health, which is essential for thyroid medication absorption.",
    instructions: [
    ...
    clinicalTips: [
      "Fermentation increases the bioavailability of Vitamin B12.",
      "Pair with coconut chutney to help Vitamin D absorption.",
    ],
    imageUrl: "ragi_dosa_clinical_1776603048585.png",
    protocol: {
      medGap: "60 mins",
      caution: ["Avoid with Calcium supplements", "Increase water intake"],
    },
    metabolicImpact: [
      {
        time: "30m",
        effect: "Enzyme Priming",
        description:
          "Fermented ragi initiates gut probiotic activity, preparing the metabolic pathway for nutrient uptake.",
      },
      {
        time: "2h",
        effect: "Glycemic Stability",
        description:
          "Complex fibers ensure a slow glucose release, preventing the mid-morning energy crash common in thyroid patients.",
      },
      {
        time: "4h",
        effect: "Hormone Transport",
        description: "Iron and Magnesium from ragi support peripheral T4 to T3 conversion.",
      },
    ],
    clinicalBenefits: [
      {
        title: "Bone Density",
        description: "High calcium content supports skeletal health.",
        icon: "Activity",
      },
      {
        title: "Iron Loading",
        description: "Plant-based iron for RBC synthesis.",
        icon: "Droplets",
      },
      {
        title: "Gut Health",
        description: "Prebiotic fermentation for microbiome health.",
        icon: "Shield",
      },
    ],
    aiIntelligence: {
  ...
  },
  {
    ...
    calories: 320,
    clinicalRationale:
      "Sprouts provide high digestibility and enzyme activity. Quinoa is a complete protein, crucial for maintaining muscle mass in hypothyroid patients.",
    instructions: [
    ...
    metabolicImpact: [
      {
        ...
        effect: "Enzyme Priming",
        description:
          "Sprouted enzymes facilitate rapid nutrient absorption with minimal gastric load.",
      },
      {
        time: "3h",
        effect: "Muscle Repair",
        description: "Quinoa aminos reach skeletal tissue for recovery signaling.",
      },
    ],
    clinicalBenefits: [
      { title: "Digestive Ease", description: "Low-lectin, high-enzyme sprouts.", icon: "Shield" },
      {
        ...
        description: "Complete aminos for metabolic health.",
        icon: "Activity",
      },
    ],
    aiIntelligence: {
      confidence: 0.93,
      model: "MedOra-NLP-v4",
      dataset: "Global Sprout Analytics",
    },
  },
  {
    id: "ba4",
    ...
    calories: 420,
    clinicalRationale:
      "Paneer is an excellent protein source. Zinc from seeds and dairy supports T4 to T3 conversion.",
    instructions: [
    ...
    metabolicImpact: [
      {
        time: "1h",
        effect: "Zinc Loading",
        description: "Zinc-mediated deiodinase activation begins in the liver.",
      },
      {
        time: "4h",
        effect: "Tissue Stability",
        description: "Calcium and protein provide baseline cellular repair signals.",
      },
    ],
    clinicalBenefits: [
      {
        title: "T3 Activation",
        description: "Zinc for active hormone synthesis.",
        icon: "Sparkles",
      },
      {
        title: "Skeletal Health",
        description: "High-bioavailability calcium source.",
        icon: "Activity",
      },
    ],
  ...
  },
  {
    ...
    calories: 540,
    clinicalRationale:
      "Macadamia nuts are dense in monounsaturated fats. Sea bass is a clean source of iodine for thyroid hormone production.",
    instructions: [
    ...
    metabolicImpact: [
      {
        time: "1h",
        effect: "Lipid Delivery",
        description: "Macadamia oils facilitate hormone transport across cellular membranes.",
      },
      {
        time: "3h",
        effect: "Iodine Saturation",
        description: "Clean marine iodine enters the thryoglobulin synthesis cycle.",
      },
    ],
    clinicalBenefits: [
      {
        title: "Hormone Transport",
        description: "Dense lipids for cellular entry.",
        icon: "Activity",
      },
      {
        title: "Synthesis Hub",
        description: "Iodine/Selenium synergy for T4 creation.",
        icon: "Flame",
      },
    ],
  ...
  },
  {
    ...
    calories: 280,
    clinicalRationale:
      "Fenugreek helps in blood sugar regulation, which is often linked with metabolic thyroid conditions.",
    instructions: [
    ...
    metabolicImpact: [
      {
        time: "30m",
        effect: "Glucose Dampening",
        description: "Fenugreek fiber slows gastric emptying and sugar absorption.",
      },
      {
        time: "2h",
        effect: "Iron Priming",
        description: "Plant-based iron enters the hematological transport system.",
      },
    ],
    clinicalBenefits: [
      {
        title: "Glycemic Clamp",
        description: "Stabilizes blood sugar excursions.",
        icon: "Activity",
      },
      {
        title: "Iron Recovery",
        description: "Foliage-derived iron for vitality.",
        icon: "Droplets",
      },
    ],
  ...
  },
  {
    ...
    calories: 460,
    clinicalRationale:
      "Magnesium-rich spinach supports muscle and nerve health. Brown rice provides slow-release energy.",
    instructions: [
    ...
    metabolicImpact: [
      {
        time: "1h",
        effect: "Muscular Prime",
        description: "Magnesium begins neutralizing physiological stress markers.",
      },
      {
        time: "4h",
        effect: "Hematological Flow",
        description: "Iron loading supports oxygen transport to metabolic tissues.",
      },
    ],
    clinicalBenefits: [
      {
        title: "Cortisol Management",
        description: "Magnesium-mediated stress reduction.",
        icon: "Heart",
      },
